...
import { api } from './services/api'; // Import api to access database service
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-gray-600 dark:text-gray-400 font-medium text-center md:text-left">
              © 2026 Kejah. All Rights Reserved. Built by BaruTech Solutions.
            </p>
...
const App = () => {
  // Temporary: Seed agents on app load
  useEffect(() => {
    if (api.db.seedAgents) {
      api.db.seedAgents();
    }
    if (api.db.seedListings) {
      api.db.seedListings();
    }
  }, []);
